...
\ifthenelse{\equal{\jobname}{\development}}{%
    ...
    \subsection{Lead the creation of new product development team}
    \ifthenelse{\boolean{pdf}}{%
      Develop and implement processes and CI/CD pipelines for the new team.
        \vspace{5pt}
    }{%
      % Situation
        A software project had been created for a customer and was identified
        as a potential candidate for further development.  A new team was
        created to manage the forward development of the project as a product.\\
      % Target
        The team processes and CI/CD pipelines needed to be created as well as
        providing the required infrastructure for a robust development lifecycle.\\
      % Action
        I led the team through a transition from a project to a product,
        mentoring junior members and providing technical leadership.  Driving
        a collaborative approach we defined the processes and CI/CD pipelines.\\
      % Result
        The project was successfully transitioned to a product, with the team
        being highly motivated and a development processes that has been held
        up as an example of excellence and adopted by other teams.
    }    
